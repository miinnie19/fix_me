...
public class SocketTools
{
    ...
    public static boolean ProcessConnection(SelectionKey key) throws Exception
    {
        ...
        System.out.println(Colours.ANSI_CYAN + "Client Running: " + Colours.ANSI_RESET + serverSocketChannel.getLocalAddress());
        System.out.println(Colours.ANSI_CYAN + "Client Connected to: "  + Colours.ANSI_RESET + serverSocketChannel.getRemoteAddress() + "\n");

        System.out.println(Colours.ANSI_CYAN + "ID [" + serverSocketChannel.getLocalAddress().toString().split(":")[1] +"]\n" + Colours.ANSI_RESET);
        return (true);
    }
}